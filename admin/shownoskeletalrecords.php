...
/*IDarwinCore version 1.0
  ...
  This file (shownoskeletalrecords.php) retrieves records
  from the noskeletalrecords table and displays them.
*/
...
//include the header.php which is displayed at the top of every page
include_once("header.php");

//include connect.php which has the credentials necessary for connecting to MySQL along with database name to be selected for use
include("connect.php");

//include common.php which holds many global variables that are used to customize IDarwinCore
include("common.php");
...
$query = "SELECT * FROM noskeletalrecords ORDER BY catalogNumber";
...
//display footer on the botto of every page which contains software name, version, author, copyright, and contact information
